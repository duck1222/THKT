...
- Bộ vi xử lí (CPU)
- Bộ nhớ (Ram)
- Hệ thống lưu trữ dữ liệu/Ổ cứng (SSD/HDD)
...
1. Các nhân vật nổi tiếng
- Jacques de Vaucanson (1709-1782)
 + Con vịt tự động (bơi, tiêu hóa, phản ứng...)
 + Máy dệt tự động
- Joseph Marie Jacquard (1752-1834)
 + Máy dệt tự động
 + Điều khiển bằng thẻ đục lỗ
...
2. RAM / CPU (lắp ráp trên main)
3. Bộ xử lý trung tâm
4. Bộ nhớ
5. Hệ thống vào ra
# Bài 2: Biểu diễn thông tin và hệ thống số
## Mục tiêu
1. Trình bày được cách biểu diễn thông tin trong máy tính và một số khái niệm liên quan, đơn vị đo
2. Giải thích được cách biểu diễn số trong máy tính
3. Phân biệt được hệ thống số có theo vị trí (positional number) và hệ thống số không theo vị trí (nonpositional number)
4. Mô tả được cách biểu diễn số trong hệ nhị phân, thập phân, thập lục phân, bát phân
...
## Chuyển đổi cơ số
1. Chuyển đổi bất cứ cơ số nào sang hệ 10
2. Chuyển từ cơ số 10 sang cơ số bất kỳ
## Số nguyên có dấu
1. Số nguyên có dấu
2. Biểu diễn số nguyên có dấu
## Phép cộng – trừ trên số nguyên
1. Phép cộng số nguyên không dấu
2. Phép cộng số nguyên có dấu
3. Phép trừ số nguyên có dấu
# Bài 3: Kỹ năng sử dụng máy tính và công cụ
## Mục tiêu
1. Cung cấp nền tảng về kỹ năng sử dụng máy tính
2. Giúp sinh viên tăng hiệu quả làm việc và học tập
## Nội dung bài học
1. Sử dụng máy tính và quản lý files và thư mục
...
- Xác định đường dẫn
- Giới thiệu File Explorer
2. Sử dụng Google drive
- Google drive
- Truy cập Google Drive
- Tạo tệp tin và thư mục trên Google Drive
- Demo sử tạo files và thư mục
- Chia sẻ tập tin và thư mục
3. Kỹ thuật tìm kiếm hiệu quả với Google search
- Google Search
- Sử dụng từ khóa hiệu quả
- Sử dụng tìm kiếm nâng cao
4. Giới thiệu Generative AI và sử dụng ChatGPT
- Generative AI
- Bắt đầu sử dụng ChatGPT
- Prompt Engineering
- Zero-shot Prompting
- Few-shot Prompting
- Chain-of-Thought Prompt
- Sử dụng ChatGPT trong học tập
- Đạo đức sử dụng AI trong học tập
# Bài 4: Linux
## Hệ điều hành Linux
1. Hệ điều hành
2. Tại sao lại là Linux
